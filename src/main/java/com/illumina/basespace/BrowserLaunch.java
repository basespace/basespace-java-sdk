    ...
    static void openURL(String url)
    {
        ...
        { // library not available or failed
            ...
            try
            {
                ...
                else if (osName.startsWith("Windows")) Runtime.getRuntime().exec(
                ...
                { // assume Unix or Linux
                    ...
                    for (String b : browsers)
                        if (browser == null
                                && Runtime.getRuntime().exec(new String[] { "which", b }).getInputStream().read() != -1) Runtime
                                .getRuntime().exec(new String[] { browser = b, url });
